...
function makeTableFromCountry(country) {
	...
	tab +='<tr> <td>' + country[0] + " - " + country[1] + '</td> </tr>';
...
{
	elem.innerHTML += makeTableFromCountry(countries[i]) + "<br>";
...
// 		  cell.textContent = Array.isArray(subItem) ? subItem.join(", ") : subItem;
...
var tableHtml = "<table id='countriesTable'>";

  // Add table headers
  tableHtml += "<tr>";
  for (var i = 0; i < about.length; i++) {
    tableHtml += "<th>" + about[i] + "</th>";
  }
  tableHtml += "</tr>";
